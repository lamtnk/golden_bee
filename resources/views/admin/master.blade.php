...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin.question.index')}}">
                {{-- <div class="sidebar-brand-icon ">
                    <img src="{{ asset('img/logo.svg') }}" width="60%">
                </div> --}}
                <div class="sidebar-brand-text mx-3">FPT Polytechnic</div>
            </a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item  {{ Request::is('admin.question.index') ? 'active' : '' }}">
